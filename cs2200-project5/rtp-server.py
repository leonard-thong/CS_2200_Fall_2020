...
def leetspeak(message):
    newmessage = message;
    newmessage = newmessage.replace("e","3")
    newmessage = newmessage.replace("E","3")

    newmessage = newmessage.replace("s","$")
    newmessage = newmessage.replace("S","$")

    newmessage = newmessage.replace("o","0")
    newmessage = newmessage.replace("O","0")

    newmessage = newmessage.replace("l","1")
    newmessage = newmessage.replace("L","1")

    newmessage = newmessage.replace("t","7")
    newmessage = newmessage.replace("T","7")

    newmessage = newmessage.replace("a","@")
    newmessage = newmessage.replace("A","@")

    newmessage = newmessage.replace("i","!")
    newmessage = newmessage.replace("I","!")

    newmessage = newmessage.replace("b","8")
    newmessage = newmessage.replace("B","8")
